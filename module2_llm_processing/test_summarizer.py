...
def run_tests():
    ...
    print("--- Testing Module 2 (Summarizer) ---")
    ...
    try:
        text_output = process_module_data(text_input)
    ...
    image_input = {
        ...
        "page_number": 2,
        "content_type": "Image",
        "generated_image_path": "mock_image.png", # This file likely doesn't exist yet!
        "content_location": "Top right corner"
    }
    
    try:
        image_output = process_module_data(image_input)
